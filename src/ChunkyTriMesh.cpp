...
bool rcCreateChunkyTriMesh(const float* verts, const size_t* tris, int ntris,
	int trisPerChunk, rcChunkyTriMesh* cm)
{
	...
	int curTri = 0;
	int curNode = 0;
	subdivide(items, ntris, 0, ntris, trisPerChunk, curNode, cm->nodes, nchunks * 4, curTri, cm->tris, (int*)tris);
