...
//////////////////////////////////////////////////////////////////////////////////////////
dtNavMeshQuery::dtNavMeshQuery() : m_nav(nullptr),
                                   m_tinyNodePool(nullptr),
	m_nodePool(nullptr),
	m_openList(nullptr)
{
...
dtMeshTile* dtNavMeshQuery::getNeighbourTileAt() const
{
	return nullptr;
}
	...
	for (int i = 0, j = (int)poly->vertCount - 1; i < (int)poly->vertCount; j = i++)
	{
		...
		else
		{
			...
			if (poly->neis[j])
			{
				...
				ref1 = m_nav->getPolyRefBase(tile) | idx;
				if (!filter->passFilter(ref1, tile, &tile->polys[idx]))
					ref1 = 0;
			}

			// If the edge leads to another polygon and portals are not stored, skip.
			if (ref1 != 0 && !storePortals)
				continue;
